...
let tempUnspentOuts = transaction_1.processTransactions(blockchain[0].data, [], 0);
let unspentTxOuts;
...
const hashMatchesDifficulty = (hash, difficulty) => {
    let tempHashInBinary = utils_1.hexToBinary(hash);
    if (tempHashInBinary != null) {
        const hashInBinary = tempHashInBinary;
